      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <div className="mt-1 flex items-center gap-2">
            <h2 className="text-xl font-semibold text-slate-900">Top signals to review</h2>
            <SectionHelpTooltip text="Gives you a daily shortlist so you can review important signals first." />
          </div>
        </div>
        <Link
